...
const events = [
  {
    ...
    image:
      ...
      "/data/frontendref/images/eventImages/Advising.jpg",
  },
  {
    name: "Socktober",
    ...
    image:
      process.env.REACT_APP_ASSET_URL +
      "/data/frontendref/images/eventImages/socktober.jpg",
  },
  {
    name: "Career Fair",
    date: "October 15th",
    ...
    image:
      process.env.REACT_APP_ASSET_URL +
      "/data/frontendref/images/eventImages/TivoliMain.webp",
  },
  {
    ...
    image:
      process.env.REACT_APP_ASSET_URL +
      "/data/frontendref/images/eventImages/Health.jpg",
  },
  {
    ...
    image:
      process.env.REACT_APP_ASSET_URL +
      "/data/frontendref/images/eventImages/JSSB.jpg",
  },
  {
    ...
    image:
      process.env.REACT_APP_ASSET_URL +
      "/data/frontendref/images/eventImages/culture.webp",
  },
  {
    ...
    image:
      process.env.REACT_APP_ASSET_URL +
      "/data/frontendref/images/eventImages/tivoli.jpg",
  },
  {
    ...
    image:
      process.env.REACT_APP_ASSET_URL +
      "/data/frontendref/images/eventImages/environment.webp",
  },
  {
  ...
  },
  {
    ...
    image:
      process.env.REACT_APP_ASSET_URL +
      "/data/frontendref/images/eventImages/GradSchool.jpg",
  },
];
